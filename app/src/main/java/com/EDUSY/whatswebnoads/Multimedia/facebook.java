...
public class facebook extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        instagram=findViewById(R.id.facebook);
        getSupportActionBar().hide();
        instagram.setWebViewClient(new WebViewClient());
        instagram.loadUrl("https://www.facebook.com/");
        instagram.getSettings().setJavaScriptEnabled(true);
        instagram.getSettings().setSupportMultipleWindows(true);
        instagram.getSettings().setUserAgentString("Mozilla/5.0 (Linux; Win64; x64; rv:46.0) Gecko/20100101 Firefox/68.0");
        CookieManager cookieManager = CookieManager.getInstance();
        cookieManager.setAcceptCookie(true);
        instagram.getSettings().setJavaScriptCanOpenWindowsAutomatically(true);
        ...
        instagram.setWebChromeClient(new WebChromeClient() {
            ...
            public void openFileChooser(ValueCallback<Uri> uploadMsg) {
                ...
                i.setType("*/*");
                facebook.this.startActivityForResult(Intent.createChooser(i, "File Chooser"), FCR);
            }
            ...
            public void openFileChooser(ValueCallback uploadMsg, String acceptType) {
                ...
                i.addCategory(Intent.CATEGORY_OPENABLE);
                i.setType("*/*");
                facebook.this.startActivityForResult(
            ...
            public void openFileChooser(ValueCallback<Uri> uploadMsg, String acceptType, String capture) {
                ...
                i.addCategory(Intent.CATEGORY_OPENABLE);
                i.setType("*/*");
                facebook.this.startActivityForResult(Intent.createChooser(i, "File Chooser"), facebook.FCR);
            }
            //For Android 5.0+
            public boolean onShowFileChooser(
                ...
                if (takePictureIntent.resolveActivity(facebook.this.getPackageManager()) != null) {
                    File photoFile = null;
                    try {
        ...
        instagram.setDownloadListener(new DownloadListener() {
            @Override
            public void onDownloadStart(String url, String userAgent, String contentDisposition, String mimetype, long contentLength) {
                ...
                if (Build.VERSION.SDK_INT >=Build.VERSION_CODES.M)
                {
                    if (checkSelfPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE)== PackageManager.PERMISSION_GRANTED)
                    {
                        ...
                        ActivityCompat.requestPermissions(facebook.this,new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},1);
                    }
    ...
    public void DownloadDialog(final String Url,final String Useragent,String contentdisposition,String mimetype)
    {
        ...
        builder.setTitle("Downloading")
                .setMessage("Do You Want to Downloading"+' '+" "+filename+" "+' ')

...
public class Instagram extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        instagram.loadUrl("https://www.instagram.com/?hl=en");
        ...
        instagram.setWebChromeClient(new WebChromeClient() {
            ...
            public void openFileChooser(ValueCallback<Uri> uploadMsg) {
                ...
                i.setType("*/*");
                Instagram.this.startActivityForResult(Intent.createChooser(i, "File Chooser"), FCR);
            }
            ...
            public void openFileChooser(ValueCallback uploadMsg, String acceptType) {
                ...
                i.addCategory(Intent.CATEGORY_OPENABLE);
                i.setType("*/*");
                Instagram.this.startActivityForResult(
            ...
            public void openFileChooser(ValueCallback<Uri> uploadMsg, String acceptType, String capture) {
                ...
                i.addCategory(Intent.CATEGORY_OPENABLE);
                i.setType("*/*");
                Instagram.this.startActivityForResult(Intent.createChooser(i, "File Chooser"), Instagram.FCR);
            }
            //For Android 5.0+
            public boolean onShowFileChooser(
                ...
                if (takePictureIntent.resolveActivity(Instagram.this.getPackageManager()) != null) {
                    File photoFile = null;
                    try {
